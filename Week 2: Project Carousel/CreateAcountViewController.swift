...
class CreateAcountViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        initialY = formView.frame.origin.y
    ...
    //DEFINE METHOD TO CALL KEYBOARD
    func keyboardWillShow(notification: NSNotification!) {
        ...
        UIView.animateWithDuration(animationDuration, delay: 0.0, options: UIViewAnimationOptions(rawValue: UInt(animationCurve << 16)), animations: {
            ...
            self.formView.frame.origin = CGPoint(x: self.formView.frame.origin.x, y: self.initialY + self.offset)
    ...
    func keyboardWillHide(notification: NSNotification!) {
        ...
        UIView.animateWithDuration(animationDuration, delay: 0.0, options: UIViewAnimationOptions(rawValue: UInt(animationCurve << 16)), animations: {
            ...
            self.formView.frame.origin = CGPoint(x: self.formView.frame.origin.x, y: self.initialY)
